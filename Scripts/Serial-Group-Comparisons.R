...
#' Statistics:
#' Kruskal-Wallis Rank Sum Test (one-way annova on ranks) is applied.
#' Wilcoxon Rank Sum Test is used for pairwise comparisons (only significant differences are shown in the graphical PDF output).
...
input_filename = "TaxaCombined.tab"              #<--- CHANGE ACCORDINGLY !!!

#' The name of the independant variable that the analysis will be performed on
independant_variable_name <- "disease_state"
